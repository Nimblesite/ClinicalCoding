...
3. Extract the ordered list of commands the CI actually runs (e.g., `make lint`, `make test`, `make build`, or whatever the workflow specifies — it may use `npm`, `cargo`, `dotnet`, raw shell commands, or anything else).
