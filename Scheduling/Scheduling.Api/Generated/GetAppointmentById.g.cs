...
/// <summary>
/// Extension methods for 'GetAppointmentById'.
/// </summary>
public static partial class GetAppointmentByIdExtensions
{
    /// <summary>
    /// Executes 'GetAppointmentById.sql' and maps results.
    /// </summary>
        ...
        try
        {
            ...
            using (var command = new NpgsqlCommand(sql, connection))
            {
                ...
                using (var reader = await command.ExecuteReaderAsync().ConfigureAwait(false))
                {
                    ...
                    {
                        var item = new GetAppointmentById(
            ...
            return new Result<ImmutableList<GetAppointmentById>, SqlError>.Ok<ImmutableList<GetAppointmentById>, SqlError>(results.ToImmutable());
        }
        catch (Exception ex)
        {
            return new Result<ImmutableList<GetAppointmentById>, SqlError>.Error<ImmutableList<GetAppointmentById>, SqlError>(new SqlError("Database error", ex));
        }
    }
}

/// <summary>
/// Result row for 'GetAppointmentById' query.
/// </summary>
public record GetAppointmentById
{
    ...
    /// <summary>Initializes a new instance of GetAppointmentById.</summary>
