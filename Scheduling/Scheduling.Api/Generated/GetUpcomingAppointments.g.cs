        ...
        try
        {
            ...
            using (var command = new NpgsqlCommand(sql, connection))
            {
                ...
                using (var reader = await command.ExecuteReaderAsync().ConfigureAwait(false))
                {
                    ...
                    {
                        var item = new GetUpcomingAppointments(
            ...
            return new Result<ImmutableList<GetUpcomingAppointments>, SqlError>.Ok<ImmutableList<GetUpcomingAppointments>, SqlError>(results.ToImmutable());
        }
        catch (Exception ex)
        {
            return new Result<ImmutableList<GetUpcomingAppointments>, SqlError>.Error<ImmutableList<GetUpcomingAppointments>, SqlError>(new SqlError("Database error", ex));
        }
    }
}

/// <summary>
/// Result row for 'GetUpcomingAppointments' query.
/// </summary>
public record GetUpcomingAppointments
{
    ...
    /// <summary>Initializes a new instance of GetUpcomingAppointments.</summary>
