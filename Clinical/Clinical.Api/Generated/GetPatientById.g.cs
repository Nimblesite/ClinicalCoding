...
/// <summary>
/// Extension methods for 'GetPatientById'.
/// </summary>
public static partial class GetPatientByIdExtensions
{
    /// <summary>
    /// Executes 'GetPatientById.sql' and maps results.
    /// </summary>
    ...
    public static async Task<Result<ImmutableList<GetPatientById>, SqlError>> GetPatientByIdAsync(this NpgsqlConnection connection, object id)
    {
        const string sql = @"SELECT fhir_Patient.Id, fhir_Patient.Active, fhir_Patient.GivenName, fhir_Patient.FamilyName, fhir_Patient.BirthDate, fhir_Patient.Gender, fhir_Patient.Phone, fhir_Patient.Email, fhir_Patient.AddressLine, fhir_Patient.City, fhir_Patient.State, fhir_Patient.PostalCode, fhir_Patient.Country, fhir_Patient.LastUpdated, fhir_Patient.VersionId FROM fhir_Patient WHERE fhir_Patient.Id = @id";

        try
        {
            var results = ImmutableList.CreateBuilder<GetPatientById>();
            ...
            return new Result<ImmutableList<GetPatientById>, SqlError>.Ok<ImmutableList<GetPatientById>, SqlError>(results.ToImmutable());
        }
        catch (Exception ex)
        {
            return new Result<ImmutableList<GetPatientById>, SqlError>.Error<ImmutableList<GetPatientById>, SqlError>(new SqlError("Database error", ex));
        }
    }
}

/// <summary>
/// Result row for 'GetPatientById' query.
/// </summary>
public record GetPatientById
{
    ...
    /// <summary>Initializes a new instance of GetPatientById.</summary>
